...
status = ['Made by 𒆜ᶜʳᵃ͢͢͢ˢʰ𒆜#9999', 'Music is the Best', 'Music is Cool']
...
async def credits(ctx):
    await ctx.send('Made by `𒆜ᶜʳᵃ͢͢͢ˢʰ𒆜#9999`')
    await ctx.send('Thanks to `ME')
    await ctx.send('Thanks to `ME` command')
...
client.run('NzU1NDE4MTcyNTE3MTIyMTY5.X2C__w.Tpk0k0RuekA0lGOWyI42aMrIFfg')